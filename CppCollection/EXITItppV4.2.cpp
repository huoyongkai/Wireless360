...
double EXITItpp::sigma2A;//allocate memory for static member variable

double EXITItpp::extrinsic_mutual_info(const itpp::vec &obs, const itpp::bvec &cond, const int &N)
{
...
double EXITItpp::gaussian_fct(const double x)
{
